      ...
      <div id="mine-left" className="card w-96 bg-base-100 card-mine">
        <div className="card-body">
          ...
          <p className="text-justify">
            ...
            started back after a long time in 2017 and achieved Secondary School
            Certificate in 2020 from Bangladesh Open University.
            <br></br>I love reading books, playing chess, and learning new
